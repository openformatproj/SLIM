 ...
 * This is exactly how Stateflow manages events, according to a semantic that is the opposite of that adopted by UML (and that reflects in some way the OOP conventions, if states are considered as classes inheriting
 * attributes from higher level states). The main advantage is that this solution doesn't need any dynamic binding of methods, because state is not a polymorphic entity anymore.
